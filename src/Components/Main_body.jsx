...
const Body = () => {
    return (
        <div className="p-6 bg-gray-900 min-h-screen">
            {/* Portfolio Section */}
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white mt-5 mx-auto w-4/5 h-[14vh] p-6 rounded-2xl transition-all duration-300 hover:bg-gray-700 shadow-xl flex justify-between items-center">
                <div>
            ...
            <div className="flex flex-wrap justify-center mt-5 gap-6">
                <div className="bg-gray-800 text-white w-[55%] h-[38vh] p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="mt-4">
                        ...
                        <img className="w-full h-[18vh] mt-2 rounded-lg" src={Graph} alt="Graph" />
                    </div>
                </div>

                <div className="bg-gray-800 text-white w-[35%] h-[38vh] p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col justify-between">
                    <div>
                        <p className="text-lg font-medium opacity-80">Deposit</p>
                        <p className="text-2xl font-semibold text-green-400">+ 81,123.10</p>
                    </div>
                    <div>
                        <p className="text-lg font-medium opacity-80">BTC Sell</p>
                        <p className="text-2xl font-semibold text-red-400">-1.248513391 BTC</p>
                    </div>
                    <div>
                        <p className="text-lg font-medium opacity-80">Last Trade</p>
                        <p className="text-2xl font-semibold text-green-400">+1124.990</p>
                    </div>
                </div>
            </div>
                ...
                <div className="flex justify-between">
                    <div>
                        ...
                        <ul className="mt-2 space-y-1 text-sm opacity-90">
                            <li>Bought 0.5 BTC - $5,000</li>
                            <li>Sold 0.2 BTC - $2,000</li>
                            <li>Deposited $1,000</li>
                        </ul>
                    </div>
                    <div>
                        <p className="text-lg font-medium opacity-80">Notifications</p>
                        <ul className="mt-2 space-y-1 text-sm opacity-90">
                            <li>Price Alert: BTC reached $11,000</li>
                            <li>New Deposit of $1,000</li>
                            <li>Withdrawal of $500</li>
                        </ul>
                    </div>
                </div>
            </div>
